...
- `templates/base.html` — navbar shows the signed-in user's name next to the Log out link (definition-of-done requirement)
- `static/css/style.css` — new category colour tokens in `:root`
